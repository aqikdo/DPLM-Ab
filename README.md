...
Quick validation scripts and optional CAMEO benchmark subset: see [`tests/smoke/README.md`](tests/smoke/README.md).

```bash
pip install torch_scatter fairscale  # if not already installed
