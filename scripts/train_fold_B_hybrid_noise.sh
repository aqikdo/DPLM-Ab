#!/usr/bin/env bash
# fold_B: 50% original noise + 50% progressive CDR (0.1→1.0 @1500).
set -euo pipefail
cd "$(dirname "$0")/.."
...
NAME="${1:-fold_B_hybrid_noise_epi01}"
EXP="dplm2_650m_vhh_mfdesign_antigen_fold_hybrid_noise"
...
echo "Config: 100% folding, 50% original + 50% CDR progressive @1500, max_steps=1500"
